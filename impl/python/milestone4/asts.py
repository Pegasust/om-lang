...
class AST:
    ...
    def __eq__(self, other) -> bool:
        assert False, f"AST.__eq__() not implemented for {type(self)}"
...
class Program(AST):
    ...
    def __eq__(self, other):
        return (
            ...
            and all(self.decls[i] == other.decls[i] for i in range(len(self.decls)))
        )
...
class Id(AST):
    ...
    def __eq__(self, other):
        return isinstance(other, Id) and self.token == other.token
...
class VarDecl(AST):
    ...
    def __eq__(self, other):
        return (
            ...
            and self.type_ast == other.type_ast
        )
...
class IntType(Type):
    ...
    def compare(self, other: AST, fn: Callable[[AST, AST], bool]) -> bool:
        return isinstance(other, IntType) and fn(self, other)
...
class BoolType(Type):
    ...
    def compare(self, other: AST, fn: Callable[[AST, AST], bool]) -> bool:
        return isinstance(other, BoolType) and fn(self, other)
...
class ArrayType(Type):
    ...
    def __eq__(self, other):
        return (
            ...
            and self.element_type_ast == other.element_type_ast
        )
...
class PrintStmt(Stmt):
    ...
    def __eq__(self, other):
        return isinstance(other, PrintStmt) and self.expr == other.expr
...
class CompoundStmt(Stmt):
    def __init__(
        ...
        self.return_stmt: ReturnStmt | None = return_stmt
    ...
    def __eq__(self, other):
        return (
            ...
            and all(self.stmts[i] == other.stmts[i] for i in range(len(self.stmts)))
            and self.return_stmt == other.return_stmt
        )
...
class FuncDecl(AST):
    def __init__(
        ...
        ret_type_ast: Type | None,
        body: CompoundStmt,
    ):
        self.id = id
        self.params: list[ParamDecl] = params
        self.ret_type_ast: Type | None = ret_type_ast
    ...
    def __eq__(self, other):
        return (
            ...
            and all(self.params[i] == other.params[i] for i in range(len(self.params)))
            and self.ret_type_ast == other.ret_type_ast
...
class IfStmt(Stmt):
    def __init__(
        ...
        elseStmt: CompoundStmt | None,
        coord: Coord,
    ):
        self.expr: Expr = expr
        self.thenStmt: CompoundStmt = thenStmt
        self.elseStmt: CompoundStmt | None = elseStmt
        self.coord: Coord = coord
    ...
    def __eq__(self, other):
        return (
            ...
            and self.thenStmt == other.thenStmt
            and self.elseStmt == other.elseStmt
        )
...
class CallStmt(Stmt):
    ...
    def __eq__(self, other):
        return isinstance(other, CallStmt) and self.call == other.call
...
class ReturnStmt(Stmt):
    def __init__(self, expr: Expr | None, coord: Coord):
    ...
    def __eq__(self, other):
        return isinstance(other, ReturnStmt) and self.expr == other.expr
...
class IntLiteral(Expr):
    ...
    def __eq__(self, other):
        return isinstance(other, IntLiteral) and self.token == other.token

    def __repr__(self):
        return f"IntLiteral({self.token.__repr__()})"

    def compare(self, other: AST, fn: Callable[[AST, AST], bool]) -> bool:
        return isinstance(other, IntLiteral) and fn(self, other)
...
class TrueLiteral(Expr):
    ...
    def compare(self, other: AST, fn: Callable[[AST, AST], bool]) -> bool:
        return isinstance(other, TrueLiteral) and fn(self, other)
...
class FalseLiteral(Expr):
    ...
    def compare(self, other: AST, fn: Callable[[AST, AST], bool]) -> bool:
        return isinstance(other, FalseLiteral) and fn(self, other)
...
class IdExpr(Expr):
    ...
    def __eq__(self, other):
        return isinstance(other, IdExpr) and self.id == other.id
